...
symmetry,NOSYM
 ...
 dummy,Al7,Al8,Al9,Al10,Al11,Al12
...
ADD,H0,1,one_int,1,emb_int;print,H0
SAVE,H0,1200.1,h0
}
...
load,d,DEN;
COUL,J,d;
add,test,1,IM2,1,VSM,-2,J,-1,VXC;
save,test,7900.2,square
}

{matrop
READ,myden1,FILE=myden1.molpro
save,myden1,6400.2,DENSITY
}
...
load,EPOT;
add,VS,1,EPOT,-1,EPOT
load,vxc,triang,8100.1;print,vxc
save,VS,7100.2,square
...
{matrop;
load,VSM,square,7100.1;
load,d,DEN,6400.2;
COUL,J,d;print,J
save,J,6400.1,square
load,test,square,7900.2;
add,VS,1.0,VSM,-2,J,-1,test
save,VS,7100.2,square
}
...
{matrop;
load,VS,square,7100.2;
load,IM2,square,7200.1;
add,VS,1.0,VS,1.0,IM2;
...
if(deltaE.lt.1e-16) then
  ...
  load,H0,h0,1200.1;
  load,EKIN;
  add,EPOT1,1,H0,-1,EKIN
  READ,VS,FILE=vemb_f.molpro
  save,VS,7100.2,square
  load,d,DEN;
  load,EKIN
  trace,ek_sys1,EKIN,d
  trace,e_ion1,EPOT1,d
  coul,vj,d
  load,test,square,7900.2;
