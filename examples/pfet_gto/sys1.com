...
{matrop,
READ,cas_orb,FILE=casorb_sys1_2
save,cas_orb,2141.2,ORBITALS}

{multi,
 START,2141.2,NATURAL
 closed,8
 occ,20}
...
load,H0;print,H0
load,EKIN
add,test1,1,H0,-1,EKIN;print,test1  
!load,vxc,triang,8100.1;print,vxc
add,VS,1,test1,-1,test1;
save,VS,7100.2,square
load,d,DEN,2140.2;print,d
